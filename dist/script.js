...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_slider__WEBPACK_IMPORTED_MODULE_1__["default"])('.feedback-slider-item', 'h', '.main-prev-btn', '.main-next-btn');
...
var checkTextInput = function checkTextInput(selectorInput) {
  var textInputs = document.querySelectorAll(selectorInput);
...
var drop = function drop() {
  ...
  // dragstart
  // drop - объект отпустили в dropArea
...
var filter = function filter() {
  var menu = document.querySelector('.portfolio-menu'),
      ...
      markLoveers = wrapper.querySelectorAll('.lovers'),
...
var mask = function mask(selectorInput) {
  ...
  function bindModal(modalTriggerSelector, modalWindowSelector, modalCloseBtnSelector) {
    ...
    modalWindow.addEventListener('click', function (e) {
      if (e.target === modalWindow) {
        ...
        modalWindow.style.display = 'none'; // modalWindow.classList.remove('animation-modal') ;
...
var scrolling = function scrolling(upSelector) {
  ...
  window.addEventListener('scroll', function () {
    if (document.documentElement.scrollTop > 1650) {
      //document.documentElement.scrollTop сколько проскролили сверху
...
var sliders = function sliders(slidesSelector, direction, prev, next) {
  var slideIndex = 1,
      paused = false;
